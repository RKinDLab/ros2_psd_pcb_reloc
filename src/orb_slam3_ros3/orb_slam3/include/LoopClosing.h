...
public:
    ...
    //* SSS: Loop Detection variables
    double nGlobalScale = 1.0;
...
// #endif
    ...
    EIGEN_MAKE_ALIGNED_OPERATOR_NEW // Can we safely turn this off??

protected:

    bool CheckNewKeyFrames(); // From original ORB_SLAM
    ...
    //* DetectCommonRegions may be the place to provide our overloads
    ...
    //* SSS - Semantic Spatial Structure (DEPRICITED)
    bool DoLoopClosureWithSSS(KeyFrame* &pMatchedKF, KeyFrame* &pLastCurrentKF, g2o::Sim3 &g2oScw, std::vector<MapPoint*> &vpMPs, std::vector<MapPoint*> &vpMatchedMPs);
    ...
    KeyFrame* mpOriginKF; // First Keyframe after initialization
    ...
    //* ------- variables for the new loop detection method
    Map* mpLastMap;
    ...
    bool mbActiveReffineSim3 = true; //* Set true to activate if(mnLoopNumCoincidences > 0) in LoopClosing.cc
