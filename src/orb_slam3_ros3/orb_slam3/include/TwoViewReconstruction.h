...
-- Added new heuristic of choosing between homography and essential matrix fitting
...
namespace ORB_SLAM3
{
    ...
    public:
        EIGEN_MAKE_ALIGNED_OPERATOR_NEW // This throws a lot of error
        // Fix the reference frame
        // This is the class constructor. It's name is exactly same as it s class and its has no return
        TwoViewReconstruction(const Eigen::Matrix3f& k, float sigma = 1.0, int iterations = 200);

        // Computes in parallel a fundamental matrix and a homography
        // Selects a model and tries to recover the motion and the structure from motion
        // Contains the Kappa and ORB_SLAM3's Heuristic Strategy
        ...
        //! FLAG TO CHOOSE BETWEEN THE TWO SELECTION STRATEGIES
        bool useKappaModel = true; // Default true, set false to use proposed method
    ...
    private:
        ...
        //* This model is dubbed the "Kappa Model"
        bool CheckIfHomographyOrEssentialModel(const eigenMat3f &H_mat,const eigenMat3f &F_mat, const float cond_min, const float cond_max);
