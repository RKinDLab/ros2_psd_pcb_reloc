...
//* ***********************************************************************************************************************************************************
//* Method to get the very first KeyFrame in the Map
KeyFrame* Map::GetFirstKeyFrame(){
    // Returns the pointer to the very first KeyFrame in the Map
    unique_lock<mutex> lock(mMutexMap);
    // std::vector<KeyFrame*> vpTempo(mspKeyFrames.begin(),mspKeyFrames.end());
    return *(mspKeyFrames.begin()); // Should return the pointer to the first KeyFrame
}
//* ***********************************************************************************************************************************************************
